...
- **Navigation surfaces are options, not quotas.** Consider root groups, tabs, products, and versions against the source IA and intended user journeys. No page count or family count alone requires a switcher or header tabs. Detail lives in `style-docs` and `docs-to-mintlify/references/docs-json.md`.
